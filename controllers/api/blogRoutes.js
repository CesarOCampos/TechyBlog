...
router.get("/", withAuth, async(req, res) => { // If the user is logged in, render the create blog page
...
router.put("/edit/:id", withAuth, async(req, res) => {
    ...
    try {
        const blogPostData = await BlogPost.update({ // All the fields you can update and the data attached to the request body.
